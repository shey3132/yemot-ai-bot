...
def ai_chat():
    ...
    if not audio_path:
        ...
        return f"read=t-שלום כאן נועם במה אוכל לעזור לך היום דברו לאחר הצליל={RECORD_COMMAND}", 200
    ...
    try:
        ...
        system_prompt = (
            ...
            "אם אתה משתמש בחיפוש גוגל חובה לזקק מהמשתמש רק מילות מפתח ממוקדות "
